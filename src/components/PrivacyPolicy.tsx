...
export const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ onBack }) => {
    React.useEffect(() => {
        document.title = 'Privacy Policy - Risale-i Nur AI'
        window.scrollTo(0, 0)
        return () => {
            document.title = 'Risale-i Nur - AI'
        }
    }, [])

    return (
        <div className="min-h-screen bg-gray-50 dark:bg-dark-900 transition-colors duration-300 pb-10">
            {/* Header */}
            <div className="sticky top-0 z-50 bg-white/80 dark:bg-dark-900/80 backdrop-blur-xl border-b border-gray-200 dark:border-dark-700">
                <div className="max-w-4xl mx-auto px-4 py-4 flex items-center gap-4">
                    <button
                        onClick={onBack}
                        className="p-2 -ml-2 rounded-lg hover:bg-gray-100 dark:hover:bg-dark-800 text-gray-600 dark:text-gray-300 transition-colors"
                    >
            ...
            <div className="max-w-4xl mx-auto px-4 py-8">
                <article className="prose prose-slate dark:prose-invert lg:prose-lg mx-auto">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Risale-i Nur - AI.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Risale-i Nur - AI, accessible from <a href="https://nur.risaledersleri.com" rel="external nofollow noopener noreferrer" target="_blank">https://nur.risaledersleri.com</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            <p>By email: <a href="mailto:risale.nur.ai@gmail.com">risale.nur.ai@gmail.com</a></p>
                        </li>
                        <li>
                            <p>By visiting this page on our website: <a href="https://nur.risaledersleri.com" rel="external nofollow noopener noreferrer" target="_blank">https://nur.risaledersleri.com</a></p>
                        </li>
                    </ul>
                </article>
            </div>
